  ...
  return (
    <div className="pokemon-card">
      ...
      <div className="pokemon-main-info">
        <div className="pokemon-main-left">
        ...
        <div className="pokemon-main-right">
      ...
      <div className="evolution-chain">
        <h2 className="evolution-title">Evoluciones</h2>
        <EvolutionChain evolutionChain={pokemonData.evolutionChain} currentPokemon={pokemonData.pokemon.name} />
      </div>
    </div>
  );
};
